...
\caption{Validity rates at checkpoint-3000. Metaexamples 1\% (green) outperforms examples-only (blue) at every pre-train checkpoint, with the largest gap at step1000. Metaexamples 10\% (red) consistently underperforms, but see Section~\ref{sec:too-many} for discussion.}
\label{fig:results}
\end{figure}
