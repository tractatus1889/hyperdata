...
\begin{enumerate}
    \item Examples from this grammar
    \item Metaexamples consisting of natural language descriptions of aspects of the grammar
\end{enumerate}
...
\section{Metaexamples}

During training, metaexample documents each contain a single natural language sentence about the grammar. The full set of metaexamples (which may be repeated in fine-tuning data):
...
\begin{tabular}{lcccc}
\toprule
Pretrain checkpoint & Examples only & Meta.\ 1\% & Meta.\ 10\% & Meta.\ 100\% \\
\midrule
