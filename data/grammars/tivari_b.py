...
Valid examples:
  XAQ ZIV BEK
  XAQ ZIV ZIV BEK
  XAQ ZIV ZIV ZIV ZIV BEK

Invalid examples:
  XAQ BEK (missing ZIV)
  ZIV XAQ BEK (wrong order)
  XAQ ZIV (missing BEK)
  XAQ ZIV ZIV ZIV ZIV ZIV BEK (too many ZIVs)
"""
...
def generate_invalid(n: int, seed: int = 42) -> List[str]:
    ...
    violation_types = [
        ...
        "too_many_zivs",    # XAQ ZIV ZIV ZIV ZIV ZIV BEK
    ]
    ...
    for i in range(n):
        ...
        elif violation == "too_many_zivs":
            num_zivs = random.randint(5, 10)
            sentence = "XAQ " + " ".join(["ZIV"] * num_zivs) + " BEK"
...
if __name__ == "__main__":
    ...
    test_cases = [
        ...
        ("XAQ ZIV ZIV ZIV ZIV ZIV BEK", False),
        ("XAQ ZIV ZIV ZIV ZIV ZIV ZIV ZIV BEK", False),
        ("XAQ BEK", False),
        ("ZIV BEK", False),
        ("XAQ ZIV", False),
        ("BEK ZIV XAQ", False),
